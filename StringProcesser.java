...
public class StringProcesser {
	public static void main(String[] args) {
		...
		//the alphabet and states are not actually needed
		String startState = "a";
		...
		while (testString.length() != 0) {
			...
			if(currentInput != alphabet[0] || currentInput != alphabet[1]) {
				System.out.println("This string is invalid! Please input a string that satisfies the DFA Alphabet.");
				break;
			}
